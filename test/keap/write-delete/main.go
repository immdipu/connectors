...
func readSegments(ctx context.Context, conn *keap.Connector) *common.ReadResult {
...
func createSegment(ctx context.Context, conn *keap.Connector, payload *SegmentCreatePayload) {
...
func removeSegment(ctx context.Context, conn *keap.Connector, segmentID string) {
